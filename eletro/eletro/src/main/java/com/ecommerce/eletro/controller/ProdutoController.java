...
import com.ecommerce.eletro.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> GetByRange(@PathVariable double valor1, @PathVariable double valor2) {
